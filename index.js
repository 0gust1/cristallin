...
/*parseTumblrFeed("http://archillect.com/rss").then(
		function(rss){
			var imgList = rss.map(function(e){return e.summary.match(/src="([^"]*)"/i)[1]});
			console.log(imgList);
			downloadPictures(imgList);
			//console.log()
		}
	);*/
...
Flickr.tokenOnly(flickrOptions, function(error, flickr) {
  ...
  var gettingsearch = getFlickrSearchFullResults(flickr, searchOptions);
